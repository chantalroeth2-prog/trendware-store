...
export default function Footer() {
  return (
    <footer className="bg-gray-900 border-t border-gray-200 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <span className="text-xl font-display tracking-wide text-white">
              trend<span className="font-semibold text-brand-400">ware</span>
            </span>
            <p className="mt-3 text-sm text-gray-500">
              Smarte Produkte, die deinen Alltag verbessern. Handverlesene Qualität
              für Zuhause, Büro &amp; Fitness.
            </p>
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.instagram.com/trendware.shop/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.1] transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/992639497268300" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.1] transition-colors" aria-label="Facebook">
                <svg className="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
            </div>
            <p className="text-[10px] text-gray-500 mt-1">@trendware.shop</p>
          </div>
          ...
          {/* Kundenservice */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Kundenservice</h3>
            <ul className="space-y-2 text-sm">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-xs text-gray-400 space-y-1">
              ...
              <p>
                ...
                <Link href="/datenschutz" className="underline hover:text-gray-400">Mehr erfahren</Link>
              </p>
            </div>
            <div className="flex items-center space-x-3">
              {/* Visa */}
              <span className="px-3 py-1.5 border border-white/[0.08] rounded-lg bg-white/[0.03]">
